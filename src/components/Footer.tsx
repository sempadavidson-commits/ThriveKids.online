...
import { Heart, Shield, Lock, FileText, X, ExternalLink } from 'lucide-react';
...
export default function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="relative w-full bg-[#fcfbfa] text-stone-700 py-16 sm:py-24 px-6 sm:px-12 lg:px-20 overflow-hidden select-none">
        ...
        >
          ...
          >
            <div className="flex items-baseline leading-none cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
              <span className="text-stone-950 font-black text-3xl tracking-tighter">T</span>
              <span className="text-emerald-600 font-black text-3xl tracking-tighter ml-0.5">K</span>
              <span className="ml-3 text-xs font-mono font-bold uppercase tracking-widest text-stone-500">
                FOUNDATION (UG)
              </span>
            </div>
          ...
          <motion.div 
            layout="position"
            className="flex flex-wrap items-center justify-center gap-6 sm:gap-8 text-xs sm:text-sm font-semibold text-stone-600"
          >
            {/* Privacy Policy Link */}
            <button
              type="button"
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-[#128C7E] hover:text-[#075E54] transition-colors cursor-pointer"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 text-stone-800 hover:text-black transition-colors cursor-pointer"
            >
          ...
          <motion.div 
            layout="position"
            className="text-center lg:text-right text-[11px] text-stone-400 font-mono"
          >
        ...
        {activeModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-stone-950/60 backdrop-blur-md">
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-white rounded-3xl p-6 sm:p-10 shadow-2xl overflow-y-auto max-h-[85vh] text-left"
            >
              <div className="flex items-center justify-between pb-4">
                ...
                <button
                  ...
                  className="p-2 bg-stone-100 hover:bg-stone-200 text-stone-700 rounded-full cursor-pointer transition-all"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>

              <div className="space-y-4 text-stone-600 text-sm leading-relaxed pt-2 font-light">
                {activeModal === 'privacy' ? (
                  <>
                    <p>
              ...
              <div className="pt-6 flex justify-end">
                <button
                  type="button"
                  onClick={() => setActiveModal(null)}
                  className="px-6 py-2.5 bg-stone-900 hover:bg-stone-800 text-white text-xs font-bold uppercase tracking-wider rounded-xl transition-all cursor-pointer"
                >
                  Close Document
                </button>
              </div>
