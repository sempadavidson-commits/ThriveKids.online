...
export default function CeoProfileSection({ onExplorePrograms }: CeoProfileSectionProps) {
  return (
    <section 
      id="ceo-leadership" 
      className="relative z-10 py-16 sm:py-24 px-4 sm:px-8 lg:px-12 max-w-7xl mx-auto"
    >
      ...
      <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-3">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-50 text-emerald-800 text-xs font-mono font-bold tracking-wider uppercase shadow-xs">
      ...
      <div className="relative bg-white/80 backdrop-blur-xl rounded-[28px] sm:rounded-[36px] p-6 sm:p-10 lg:p-12 shadow-xl shadow-stone-900/5 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="relative w-full max-w-sm sm:max-w-md aspect-[4/5] rounded-[24px] overflow-hidden shadow-2xl bg-stone-100">
              <img 
                src={ceoPortrait} 
          ...
          >
            ...
            {/* Executive Quote Box - Clean without extra badges or generic icons */}
            <div className="relative bg-stone-900 text-stone-100 p-6 sm:p-7 rounded-2xl shadow-inner space-y-3">
