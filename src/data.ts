...
export const INITIAL_PROGRAMS: Program[] = [
  {
    ...
    fullDescription: 'Education is the ultimate equalizer and the foundation for long-term self-sufficiency. Our Education Support initiative addresses structural barriers limiting schooling. By e[...]',
    objectives: [
    ...
    image: 'https://images.unsplash.com/photo-1427504494785-cdaf6fbb0c21?auto=format&fit=crop&q=80&w=1200',
    stats: [
  ...
  },
  {
    ...
    fullDescription: 'Every child possesses the inalienable right to grow up safe from violence, exploitation, and abuse. Our Child Protection initiative coordinates with country courts, social st[...]',
    objectives: [
  ...
  },
  {
    ...
    fullDescription: 'The most effective way to shelter a child is to anchor their home. Our Family Strengthening programs reverse hereditary indigence by empowering mothers and guardians. We comb[...]',
    objectives: [
  ...
  },
  {
    ...
    fullDescription: 'Proper cognitive development and physical vitality require foundational nutrition and safety from disease. We integrate severe malnourishment medical wings at rural outposts[...]',
    objectives: [
    ...
    image: 'https://images.unsplash.com/photo-1579154204601-01d82de7d0d8?auto=format&fit=crop&q=80&w=1200',
    stats: [
  ...
  },
  {
    ...
    fullDescription: 'Nonprofit initiatives must leave behind self-sustaining infrastructure. Through Community Development, we cooperatively construct multi-purpose youth community structures, e[...]',
    objectives: [
    ...
    image: 'https://images.unsplash.com/photo-1576091160550-112173f7f869?auto=format&fit=crop&q=80&w=1200',
    stats: [
...
export const INITIAL_TEAM: TeamMember[] = [
  {
    ...
    category: 'leadership',
    biography: 'Dr. Vance has dedicated her entire 25-year professional life to leading child advocacy programs. She previously directed international operations at Save the Children East Africa [...]',
  ...
  },
  {
    ...
    category: 'leadership',
    biography: 'Marcus is a dual-qualified financial expert and certified public accountant with 18 years of executive non-profit administration. He spent a decade auditing global humanitarian fi[...]',
  ...
  },
  {
    ...
    category: 'board',
    biography: 'Ambassador Choi has spent 30 years in diplomatic service with the UN Advisory Council and served as special envoy for children\'s welfare in South Asia. He guarantees our operati[...]',
  ...
  },
  {
    ...
    category: 'board',
    biography: 'Sarah is an expert child defense attorney and human rights scholar. She serves as legal advisor to our board, authoring our Child Safeguarding and anti-exploitation frameworks whi[...]',
  ...
  },
  {
    ...
    category: 'advisor',
    biography: 'Dr. Mensah directs global pediatric nutrition research at Accra Medical Center. He supervises our severe acute malnourishment programs, designing clinical-grade recipes and immuni[...]',
  ...
  },
  {
    ...
    category: 'manager',
    biography: 'Laila has 12 years of hands-on program management in refugee education camps. She holds an Ed.M. in Curriculum Design and translates educational funds into actual literacy labs, t[...]',
...
export const INITIAL_SUCCESS_STORIES: SuccessStory[] = [
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?auto=format&fit=crop&q=80&w=600',
    childOrFamilyName: 'Amina & the Diallo Family',
    challenge: 'Amina was forced to quit school at age 11 to break stones in a local quarry to support her mother. Her father had passed, and the family\'s daily income was under US$1.20, leavin[...]',
    intervention: 'Our staff enrolled Amina in our Education Support database, providing a full tuition scholarship and school uniforms. We concurrently registered her mother in the Family Streng[...]',
    outcome: 'Amina completed high school at the top of her class and became her community\'s first female university applicant. She is studying medicine. Her mother\'s shop is thriving, securin[...]',
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1469165893210-2592ba1894e8?auto=format&fit=crop&q=80&w=600',
    childOrFamilyName: 'Daniel, Age 9',
    challenge: 'Daniel was smuggled into a hazardous weaving factory where he worked 14-hour shifts in hot, unventilated rooms for nominal pay, sustaining numerous chronic respiratory infections [...]',
    intervention: 'Our local Child Protection council raided the illegal site with police help and brought Daniel to our Hope Shelter. Here, he received medical care, psychological counseling, an[...]',
    outcome: 'Daniel was enrolled in full schooling and has spent two years living safely with his grandmother. He is healthy and participates in community sports programs, with school fees fully[...]',
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1488521787991-ed7fe863eac5?auto=format&fit=crop&q=80&w=600',
    childOrFamilyName: 'The Mwangi Twins (Liam & Noah)',
    challenge: 'At just 14 months old, twins Liam and Noah suffered from acute muscle-wasting malnutrition (marasmus) due to localized drought. Their mother had search-walked miles every day with[...]',
    intervention: 'A ThriveKids mobile clinic identified the family, and the twins were received into our intense Health & Nutrition inpatient ward. Here, they were stabilized with clinical elect[...]',
    outcome: 'Within five months, the twins returned to healthy weight and development. Their village now enjoys robust water, which allows their parents to grow vegetables to sustain their kids [...]',
...
export const INITIAL_NEWS: NewsArticle[] = [
  {
    ...
    content: 'We are incredibly proud to share that our recent global financial audits verified that 87.2% of all donor contributions went directly into operational programs for vulnerable childr[...]',
  ...
  },
  {
    ...
    content: 'We have secured a landmark capital partner coalition with major technology providers to construct and launch 15 solar-powered tech classrooms across semi-arid African schools. This [...]',
  ...
  },
  {
    ...
    content: 'Our comprehensive Child Safeguarding and Protection Policy, which enforces strict screening for all staff and volunteers, was selected as a global masterclass model by the Internati[...]',
...
export const INITIAL_GALLERY: GalleryItem[] = [
  {
    ...
    category: 'education',
    imageUrl: 'https://images.unsplash.com/photo-1427504494785-cdaf6fbb0c21?auto=format&fit=crop&q=80&w=400'
  },
  {
    id: 'gal-2',
    ...
    category: 'health',
    imageUrl: 'https://images.unsplash.com/photo-1579154204601-01d82de7d0d8?auto=format&fit=crop&q=80&w=400'
  },
  {
    id: 'gal-3',
    ...
    category: 'community',
    imageUrl: 'https://images.unsplash.com/photo-1576091160550-112173f7f869?auto=format&fit=crop&q=80&w=400'
  },
  {
    id: 'gal-4',
    ...
    category: 'protection',
    imageUrl: 'https://images.unsplash.com/photo-1559027615-cd2628902d4a?auto=format&fit=crop&q=80&w=400'
  },
  {
    id: 'gal-5',
...
export const FAQS = [
  {
    ...
    answer: 'We maintain strict compliance with our UNICEF-validated Child Safeguarding Policy. We never publish child surnames, specific geolocation coordinates, or personal school locations pub[...]'
  },
  {
    question: 'What portion of my financial contribution directly finances field projects?',
    answer: 'A remarkable 87.2% of all expenses go directly to core fields (nutritional feeding, teacher pay, building boreholes, crisis shelters, and medical packs). Under 10% supports critical [...]'
  },
  {
    question: 'How frequently does your foundation publish audited financial reports?',
    answer: 'We publish full accredited financial statements and IRS declarations online within 90 days of the fiscal year\'s close (by April 30th annually). These reports are prepared by indepe[...]'
  },
  {
    question: 'Can I apply for a professional role or field volunteering in remote centers?',
    answer: 'Absolutely. We review skills-based applications quarterly. All program staff, physical volunteers, and partner consultants must pass background checks, complete child protection scre[...]'
  }
];
